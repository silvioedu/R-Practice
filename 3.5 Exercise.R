...
print(round(sd(lvl),0))

#Functions to use: sum(), mean(), median(), length(), sd(), round(), print()

# Tip: when typing code in the console and you want to run different commands 
# on the same object, use the Up Arrow to access the last command you executed, 
# and simply edit the function call, keeping the rest the same.