# Imagine that you are working for the Ghostbusters, and for safety reasons 
# you are recording the height and weight for everyone or everything the
# team encounters. So far you have collected information about the following. 
# entities: Dr Peter Venkman, Dr Raymond Stantz, Dr. Eagon Spengler, 
# Dana Barrett, Vigo, Slimer, and the Marshmallow Man.
...
# You need to calculate the BMI for all you have data for. BMI is calculated by 
